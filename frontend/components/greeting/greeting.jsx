...
class Greeting extends React.Component{
  constructor(props){
    super(props)
    this.state = {link: window.location.href, show: false,explore: false}
  ...
  const personalGreeting = () => (
    <div>
      <div id="explore" onMouseLeave={() => (showExplore())} onMouseEnter={() => (showExplore())}><Explore clicked={this.state.explore} /></div>
      <div id="logosGit">
